            ...
            schedule_data: {
              ...
              items: {
                ...
                properties: {
                  ...
                  target_temperature: { type: "number", description: "For climate entities (entity_id starting with 'climate.') only: the target temperature in °F, computed as master temp for that mode + that zone's offset from CLIMATE TARGET PREFERENCES. Omit entirely for non-climate entities." },
